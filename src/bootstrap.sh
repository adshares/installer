...
apt-get --yes --no-install-recommends install \
    ...
    php7.4-fpm php7.4-mysql php7.4-bcmath php7.4-bz2 php7.4-curl php7.4-gd php7.4-intl php7.4-mbstring php7.4-sqlite3 php7.4-zip php7.4-simplexml php-apcu \
